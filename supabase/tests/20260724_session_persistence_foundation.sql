...
do $$ declare session_id uuid; begin
  ...
  insert into public.session_participants (session_id, display_name, role, readiness, participant_access_token_hash) values (session_id, 'Guest', 'GUEST', 'WAITING', repeat('a', 64));
