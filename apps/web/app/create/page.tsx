...
export default function CreatePage() {
  ...
  const [title, setTitle] = useState('Friday night dinner');
  return (
    <AppShell>
      <section className="page-intro">
        ...
        <p className="lede">
          Give the group a clear choice. This mock stays on this device—nothing is saved or shared.
        </p>
      </section>
      <Card>
        <form
          ...
          onSubmit={(event) => {
            ...
            router.push(`/room/${mockRoom.session.id}`);
          }}
        >
          ...
          <div>
            <div className="section-heading">
              <div>
                ...
                <p className="muted">Everyone votes on the same short list.</p>
              </div>
              <span className="status-pill">3 options</span>
            </div>
          ...
          <Button type="submit">Create mock room</Button>
        </form>
      </Card>
    </AppShell>
  );
